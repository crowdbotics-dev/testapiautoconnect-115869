...
## Project Structure
    ...
    ├── testapiautoconnect_115869  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_115869`
...
2. Clone this repo and `cd testapiautoconnect_115869`
